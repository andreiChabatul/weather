...
export class HumidityPipe implements PipeTransform {
    ...
    engHumidity: string[] = ['Very dry air', 'Dry air', 'Moderately dry air', 'Moderately humid air', 'Very humid air'];
    rusHumidity: string[] = ['Очень сухой воздух', 'Cухой воздух', 'Умеренно сухой воздух', 'Умеренно влажный воздух', 'Очень влажный воздух'];
